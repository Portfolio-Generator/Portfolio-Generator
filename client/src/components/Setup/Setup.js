      ...
      <div className="flex-row justify-center">
        <div className="bg-cream w-full container my-5 bd-dark-green rounded-3xl bd-3-5">
          <div className="p-4 font-dark-blue raleway-font text-xl text-center">
            <h2>Setting Up</h2>
            <p>Before starting, you'll need to create a free account. Please sign up with the EXACT EMAIL address that you want to display in your portfolio </p>
            ...
            <ul>
              ...
              <li>Headshot or personal photo for the "about me" section</li>
