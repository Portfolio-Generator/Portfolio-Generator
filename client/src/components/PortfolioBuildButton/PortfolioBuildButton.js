...
const PortfolioBuildButton = ({ userState, setUserState }) => {
  const handleCreateZip = async (bookId) => {
    ...
    <body>
      <header>
        <div class="container flex-row justify-space-between align-center py-3">
          <h1 class="page-title text-secondary bg-dark py-2 px-3">Vicky</h1>
          <nav class="flex-row">
            <a class="ml-2 my-1 px-2 py-1 bg-secondary text-dark" href="https://github.com/vloebel">GitHub</a>
          </nav>
        </div>
      </header>
      ...
      <section class="my-3" id="portfolio">
        ...
        <div class="flex-row justify-space-between">
            ...
            <div class="col-12 mb-2 bg-dark text-light p-3">
              <h3 class="portfolio-item-title text-light">Best Project</h3>
      ...
      <footer class="container text-center py-3">
        <h3 class="text-dark">&copy;2020 by Vicky</h3>
      </footer>
    </body>
    </html>
    `;
    ...
    * {
    ...
    ziphtml.file('index.html', string1);
    zipcss.file('style.css', string2);
